...
import { createRun } from '../hooks/useApi';
...
export default function NewRunForm({ onCreated, onCancel }: Props) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h2 className="text-lg font-semibold text-gray-800 mb-4">New Sandbox Run</h2>
